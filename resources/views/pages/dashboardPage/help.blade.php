                                ...
                                <div class="accordion" id="accordionExamplea">
                                    <div class="accordion-item card ">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body card-body">
                                                AiWaveis an AI-powered messaging platform that understands and responds to
                                                your natural language queries. Ask anything you'd typically ask a human
                                    ...
                                    <div class="accordion-item card ">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body card-body">
                                                AiWave, an AI-driven messaging platform, adeptly communicates with users
                                    ...
                                    <div class="accordion-item card ">
                                        ...
                                        <div id="collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body card-body">
                                                ...
                                                helper—whether it's about the weather, the latest news, restaurant
                                    ...
                                    <div class="accordion-item card ">
                                        ...
                                        <div id="collapseSix" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body card-body">
                                                Yes, AiWaveis designed to support multiple languages, offering a versatile
                                                and inclusive communication experience for users worldwide.
                                            </div>
                                        </div>
                                    </div>
