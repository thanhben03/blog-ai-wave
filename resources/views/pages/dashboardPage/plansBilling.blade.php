        ...
        <div class="rbt-daynamic-page-content center-width">
            ...
            <div class="rbt-dashboard-content">
                <div class="banner-area">
                    ...
                    <div class="settings-area">
                        ...
                        <ul class="user-nav">
                            ...
                            <li>
                                <a href="{{ route('pages.plans.billing') }}" class="active">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <nav class="aiwave-tab">
                                    <div class="tab-btn-grp nav nav-tabs mb-3 text-center justify-content-center"
                ...
                <div class="rainbow-pricing-detailed-area mt--60">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-left mb--30" data-sal="slide-up" data-sal-duration="400"
                                data-sal-delay="150">
                            ...
                            <div class="accordion" id="accordionExamplea">
                                <div class="accordion-item card ">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body card-body">
                                            AiWaveis an AI-powered messaging platform that understands and responds to your
                                            natural language queries. Ask anything you'd typically ask a human assistant—get
                                            weather updates, news, restaurant recommendations, and more!
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card ">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            AiWave, an AI-driven messaging platform, adeptly communicates with users using
                                            natural language understanding. It delivers helpful responses to your inquiries
                                            and requests.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card ">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            Feel free to toss any questions at AiWave, just like you would with a human
                                            helper—whether it's about the weather, the latest news, restaurant suggestions,
                                ...
                                <div class="accordion-item card ">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            Yes, AiWaveis designed to support multiple languages, offering a versatile and
                                            inclusive communication experience for users worldwide.
                                        </div>
                                    </div>
                                </div>
