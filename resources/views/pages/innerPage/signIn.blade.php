                            ...
                            <div class="signup-box-bottom">
                                <div class="signup-box-content">
                                    <div class="social-btn-grp">
                                        <a class="btn-default btn-border" href="#">
                                            <span class="icon-left"><img src="{{asset("assets/images/sign-up/google.png")}}"
                                                    alt="Google Icon"></span>Login with Google
                                        </a>
                                        <a class="btn-default btn-border" href="#">
                                            <span class="icon-left"><img src="{{asset("assets/images/sign-up/facebook.png")}}"
                                ...
                                <div class="signup-box-footer">
                                    <div class="bottom-text">
                                        Don't have an account? <a class="btn-read-more ml--5"
                                            href="{{ route('pages.sign-up') }}"><span>Sign Up</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
