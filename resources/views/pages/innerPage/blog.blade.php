                ...
                <div class="col-lg-8">
                    <div class="row mt_dec--30">
                            ...
                            <div class="row row--15">
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-01.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                                                ...
                                                <h4 class="title"><a href="{{ route('pages.blog.details') }}">Best
                                                        Corporate
                                                        Tips
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-02.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-03.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-04.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-05.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-06.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-07.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 mt--30">
                                    <div class="rainbow-card undefined">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a class="image" href="{{ route('pages.blog.details') }}"><img
                                                        src="{{ asset('assets/images/blog/blog-08.png') }}"
                                                        alt="Blog Image">
                                                </a>
                                            </div>
                                            <div class="content">
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="rainbow-load-more text-center mt--60"><button
                                ...
                                <ul>
                                    <li>
                                        <div class="list-blog-sm">
                                            ...
                                            <div class="content">
                                                <a class="d-block" href="{{ route('pages.blog.details') }}">10 ways to
                                                    supercharge
                                                    startup with Al
                                                </a>
                                    ...
                                    <li>
                                        <div class="list-blog-sm">
                                            ...
                                            <div class="content">
                                                <a class="d-block" href="{{ route('pages.blog.details') }}">Best
                                                    Corporate Tips You Will
                                                    Read This Year.
                                                </a>
            ...
            <div class="row">
                <div class="col-lg-12 mt--10">
                    <ul class="brand-list brand-style-2">
                        <li>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/brand-01.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/brand-02.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/brand-03.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/brand-04.png') }}" alt="Brand Image">
                            </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="content-left">
                                <div class="section-title text-left" data-sal="slide-up" data-sal-duration="400"
                                    ...
                                    <p class="description b1">
                                        Based on the conversation with the AI chatbot, you will receive <br> personalized
                                        recommendations.
                                    </p>
                                </div>
