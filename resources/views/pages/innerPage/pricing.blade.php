                            ...
                            <div class="row row--15">
                                <div class="col-lg-4 col-md-6 col-12 mt--30 sal-animate" data-sal="slide-up"
                                    ...
                                    <div
                                        ...
                                        <div class="bg-shape">
                                            <img src="{{ asset('assets/images/service/bg-testimonial.png') }}"
                                                alt="" class="bg">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mt--30 sal-animate" data-sal="slide-up"
                                    data-sal-duration="700">
                                    <div
                                        class="rainbow-box-card card-style-default testimonial-style-defalt has-bg-shaped">
                                        <div class="inner">
                                            <div class="rating">
                                                <a href="#rating">
                                                    <i class="fa-sharp fa-solid fa-star"></i>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bottom-content">
                                                    ...
                                                    <div class="meta-img-section">
                                                        ...
                                                        <a class="image" href="#">
                                                            <img src="{{asset("assets/images/team/team-02sm.jpg")}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="bg-shape">
                                            <img src="{{asset("assets/images/service/bg-testimonial.png")}}" alt=""
                                                class="bg">
                                            <img src="{{asset("assets/images/service/bg-testimonial-hover.png")}}" alt=""
                                                class="bg-hover">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-xl-4 col-12">
                            <div class="split-inner">
                                <h2 class="title sal-animate" data-sal="slide-up" data-sal-duration="400"
                                    data-sal-delay="200">Any question's? we have answers!</h2>
                                <p class="description sal-animate" data-sal="slide-up" data-sal-duration="400"
                                    data-sal-delay="300">Don’t find your answer here? just send us a message for any query.
                                </p>
                                <div class="contact-button mt--35 sal-animate" data-sal="slide-up"
                                    data-sal-duration="400" data-sal-delay="400">
                                    <a class="rainbow-gradient-btn without-shape" target="_blank"
                                        href="{{route('pages.contact')}}"><span>Contact us</span></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="accordion" id="accordionExampleb">
                                    <div class="accordion-item card">
                                        <h2 class="accordion-header card-header" id="headingFive">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                What is Rainbow theme - AI chat Dashboard ?
                                            </button>
                                        </h2>
                                        <div id="collapseFive" class="accordion-collapse collapse show"
                                            aria-labelledby="headingFive" data-bs-parent="#accordionExampleb">
                                            <div class="accordion-body card-body">
                                                Rainbow-AI chat is a chatbot-powered service that offers users tailored
                                                suggestions according to their interests. Natural language processing is
                                                used by the app to comprehend user inquiries and deliver precise and
                                                pertinent answers.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item card">
                                        <h2 class="accordion-header card-header" id="headingSix">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                How does the AI chatbot Rainbow operate?
                                            </button>
                                        </h2>
                                        <div id="collapseSix" class="accordion-collapse collapse"
                                            aria-labelledby="headingSix" data-bs-parent="#accordionExampleb">
                                            <div class="accordion-body card-body">
                                    ...
                                    <div class="accordion-item card">
                                        <h2 class="accordion-header card-header" id="headingSeven">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                What characteristics make Rainbow who it is?
                                            </button>
                                        </h2>
                                        <div id="collapseSeven" class="accordion-collapse collapse"
                                            aria-labelledby="headingSeven" data-bs-parent="#accordionExampleb">
                                            <div class="accordion-body card-body">
                                    ...
                                    <div class="accordion-item card">
                                        <h2 class="accordion-header card-header" id="headingEight">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                How much does Rainbow set you back?
                                            </button>
                                        </h2>
                                        <div id="collapseEight" class="accordion-collapse collapse"
                                            aria-labelledby="headingEight" data-bs-parent="#accordionExampleb">
                                            <div class="accordion-body card-body">
                                    ...
                                    <div class="accordion-item card">
                                        ...
                                        <div id="collapseNine" class="accordion-collapse collapse"
                                            aria-labelledby="headingNine" data-bs-parent="#accordionExampleb">
                                            <div class="accordion-body card-body">
                                                You can run doob easily. First You'll need to have node and npm on your
                                                machine. So Please open your command prompt then check your node -v and
                                                npm -v Version. Goes To Your your command prompt: then First: npm
                                    ...
                                    <div class="content-left">
                                        ...
                                        <div class="app-store-btn">
                                            <a class="store-btn" href="#">
                                                <img src="{{asset("assets/images/cta-img/play-app.png")}}" alt="Play Store Button">
                                            </a>
                                            <a class="store-btn" href="#">
                                                <img src="{{asset("assets/images/cta-img/apple-app.png")}}" alt="Apple Store Button">
                                            </a>
                                        </div>
                                    </div>
