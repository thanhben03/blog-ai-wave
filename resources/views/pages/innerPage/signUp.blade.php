                    ...
                    <div class="col-lg-6 bg-color-blackest left-wrapper">
                        <div class="sign-up-box">
                            <div class="signup-box-top">
                                <img src="{{ asset('assets/images/logo/logo.png') }}" alt="sign-up logo">
                            </div>
                            <div class="signup-box-bottom">
                                    ...
                                    <div class="social-btn-grp">
                                        <a class="btn-default btn-border" href="#">
                                            <span class="icon-left"><img
                                                    src="{{ asset('assets/images/sign-up/google.png') }}"
                                                    alt="Google Icon"></span>Login with Google
                                        </a>
                                        <a class="btn-default btn-border" href="#">
                                            <span class="icon-left"><img
                                                    src="{{ asset('assets/images/sign-up/facebook.png') }}"
                                ...
                                <div class="signup-box-footer">
                                    <div class="bottom-text">
                                        Do you have an account? <a class="btn-read-more ml--5"
                                            href="{{ route('pages.sign-in') }}"><span>Sign In</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
