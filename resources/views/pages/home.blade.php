...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="inner text-center mt--140">
                        ...
                        <p class="description">Unleash Brainwave's AI potential. Use the open AI <br> conversation
                            app Rainbow theme</p>
                        <div class="form-group">
                            ...
                            <a class="btn-default @@btnClass"
                                href="{{ route('tools.text.generator') }}">Start with AI</a>
                        </div>
                ...
                <div class="col-lg-11 col-xl-11 justify-content-center">
                    ...
                    <img class="slider-image-effect" src="{{ asset('assets/images/bg/slider-main-image.png') }}" alt="Banner Images">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 mt--10">
                    <ul class="brand-list brand-style-2 slider-brand slider-brand-activation">
                        <li class="slide-single-layout">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/strapi.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li class="slide-single-layout">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/mapbox.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li class="slide-single-layout">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/stenciljs.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li class="slide-single-layout">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/spotify.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li class="slide-single-layout">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/woocommerce.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li class="slide-single-layout">
                            <a href="#">
                                <img src="{{ asset('assets/images/brand/slack.png') }}" alt="Brand Image">
                            </a>
                        </li>
                        <li class="slide-single-layout">
                            <a href="#">
                ...
                <div class="col-lg-12">
                    <div class="rainbow-default-tab style-three generator-tab-defalt">
                            ...
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle"
                                    ...
                                    aria-selected="false"><span class="generator-icon"><img
                                            ...
                                            alt="Vedio Generator Icon">Vedio
                            ...
                            <li class="nav-item tabs__tab" role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle active"
                                    ...
                                    aria-selected="true"><span class="generator-icon"><img
                                            src="{{ asset('assets/images/icons/audio-g.png') }}"
                                            alt="Vedio Generator Icon">Audio
                                        Generator</span><span class="border-bottom-style"></span></button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle"
                                    ...
                                    aria-selected="false"><span class="generator-icon"><img
                                            src="{{ asset('assets/images/icons/photo-g.png') }}"
                                            alt="Vedio Generator Icon">Photo
                                        Generator</span><span class="border-bottom-style"></span></button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle" id="text-generator-tab"
                                    data-bs-toggle="tab" data-bs-target="#text-generate" type="button" role="tab"
                                    aria-controls="text-generate" aria-selected="false"><span class="generator-icon"><img
                                            src="{{ asset('assets/images/icons/text-g.png') }}"
                                            alt="Vedio Generator Icon">Text
                                        Generator</span><span class="border-bottom-style"></span></button>
                            </li>
                            <li class="nav-item tabs__tab " role="presentation">
                                <button class="nav-link rainbow-gradient-btn without-shape-circle" id="code-generator-tab"
                                    data-bs-toggle="tab" data-bs-target="#code-generate" type="button" role="tab"
                                    aria-controls="code-generate" aria-selected="false"><span class="generator-icon"><img
                                            src="{{ asset('assets/images/icons/code-g.png') }}"
                                            alt="Vedio Generator Icon">Code
                                        Generator</span><span class="border-bottom-style"></span></button>
                            </li>
                        </ul>
                        ...
                        <div class="rainbow-tab-content tab-content">
                            ...
                            <div class="tab-pane fade" id="text-generate" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 mt_md--30 mt_sm--30">
                                            <div class="export-img">
                                                <div class="inner-without-padding">
                                                    <div class="export-img img-bg-shape">
                                                        <img src="{{ asset('assets/images/generator-img/chat-export.png') }}"
                                                            alt="Chat example Image">
                                                        <div class="image-shape"></div>
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane fade" id="code-generate" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 mt_md--30 mt_sm--30">
                                            <div class="export-img">
                                                <div class="inner-without-padding">
                                                    <div class="export-img img-bg-shape">
                                                        <img src="{{ asset('assets/images/generator-img/chat-export-code.png') }}"
                                                            alt="Chat example Image">
                                                        <div class="image-shape"></div>
                                                    </div>
                                                </div>
                    ...
                    <div
                        ...
                        <div class="slide-single-layout">
                            <div class="rainbow-box-card card-style-default aiwave-service-default has-bg-shaped">
                                <div class="inner">
                                    <div class="icon">
                                        <img src="{{ asset('assets/images/icons/service-icon-01.svg') }}"
                                            alt="Servece Icon">
                                    </div>
                                    <div class="description centered-shape">
                                        <h5 class="title">Ask anything</h5>
                                        <p class="desc">Lets users quickly find answers to their questions without
                                ...
                                <div class="bg-shaped">
                                    <img src="{{ asset('assets/images/service/bg.png') }}" alt=""
                                        class="bg">
                                    <img src="{{ asset('assets/images/service/bg-hover.png') }}" alt=""
                                        class="bg-hover">
                                </div>
                            </div>
                        </div>
                        <div class="slide-single-layout">
                            <div class="rainbow-box-card card-style-default aiwave-service-default has-bg-shaped">
                                <div class="inner">
                                    <div class="icon">
                                        <img src="{{ asset('assets/images/icons/service-icon-02.svg') }}"
                                            alt="Servece Icon">
                                    </div>
                                    <div class="description centered-shape">
                        ...
                        <div class="slide-single-layout">
                            <div class="rainbow-box-card card-style-default aiwave-service-default has-bg-shaped">
                                <div class="inner">
                                    <div class="icon">
                                        <img src="{{ asset('assets/images/icons/service-icon-03.svg') }}"
                                            alt="Servece Icon">
                                    </div>
                                    <div class="description centered-shape">
    ...
    <div class="rainbow-advance-tab-area aiwave-bg-gradient rainbow-section-gap-big">
                ...
                <div class="row row--30">
                    <div class="col-lg-12">
                        <div class="tab-content">
                            <div class="tab-pane fade show active advance-tab-content-1 right-top" id="home-3"
                                            ...
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <h2 class="title sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="200">Connect with Al
                                                        chatbot</h2>
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Dentify the
                                                    ...
                                                    <div class="view-more-button mt--35 sal-animate" data-sal="slide-up"
                                                        ...
                                                        <a class="btn-default color-blacked"
                                                            href="{{ route('pages.contact') }}">Try
                                                            It Now <i
                            ...
                            <div class="tab-pane fade advance-tab-content-1" id="profile-3" role="tabpanel"
                                    ...
                                    <div class="split-wrapper">
                                        <div class="row g-0 radius-10 align-items-center">
                                            <div class="col-lg-12 col-xl-5 col-12">
                                                <div class="thumbnail">
                                                    <img class="radius"
                                                        src="{{ asset('assets/images/split/split-4.png') }}"
                                                        alt="split Images">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <h2 class="title sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="200">Streamline Your
                                                        Workflow</h2>
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Discover tools
                                                        and techniques to optimize your workflow, making your tasks
                            ...
                            <div class="tab-pane fade advance-tab-content-1" id="contact-3" role="tabpanel"
                                    ...
                                    <div class="split-wrapper">
                                        <div class="row g-0 radius-10 align-items-center">
                                            <div class="col-lg-12 col-xl-5 col-12">
                                                <div class="thumbnail">
                                                    <img class="radius"
                                                        src="{{ asset('assets/images/split/split-3.png') }}"
                                                        alt="split Images">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <h2 class="title sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="200">Protecting Your
                                                        Digital Presence</h2>
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Gain insights
                                                        into cybersecurity measures and strategies to safeguard your
                            ...
                            <div class="tab-pane fade advance-tab-content-1" id="explore-3" role="tabpanel"
                                    ...
                                    <div class="split-wrapper">
                                        <div class="row g-0 radius-10 align-items-center">
                                            <div class="col-lg-12 col-xl-5 col-12">
                                                <div class="thumbnail">
                                                    <img class="radius"
                                                        src="{{ asset('assets/images/split/split-5.png') }}"
                                                        alt="split Images">
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-xl-7 col-12">
                                                <div class="split-inner">
                                                    ...
                                                    <h2 class="title sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="200">Demystifying
                                                        Data Analytics</h2>
                                                    <p class="description sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="300">Learn the
                                                        fundamentals of data analysis, including tools and
                                                        methodologies, to extract meaningful insights from raw data.
                                                    </p>
                                                    <div class="view-more-button mt--35 sal-animate" data-sal="slide-up"
                                                        data-sal-duration="400" data-sal-delay="400">
                                                        <a class="btn-default color-blacked"
                        ...
                        <div class="advance-tab-button advance-tab-button-1 right-top">
                            <ul class="nav nav-tabs tab-button-list" id="myTab-3" role="tablist">
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="#" class="nav-link tab-button active" id="home-tab-3"
                                        data-bs-toggle="tab" data-bs-target="#home-3" role="tab"
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="#" class="nav-link tab-button" id="profile-tab-3"
                                        data-bs-toggle="tab" data-bs-target="#profile-3" role="tab"
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="#" class="nav-link tab-button" id="contact-tab-3"
                                        data-bs-toggle="tab" data-bs-target="#contact-3" role="tab"
                                ...
                                <li class="col-lg-3 nav-item" role="presentation">
                                    <a href="#" class="nav-link tab-button" id="explore-tab-3"
                                        data-bs-toggle="tab" data-bs-target="#explore-3" role="tab"
                                        aria-controls="explore-3" aria-selected="false">
                                        <div class="tab">
                                            <div class="count-text">
        ...
        <div class="bg-shape">
            <img src="{{ asset('assets/images/bg/split-bg-shape.png') }}" alt="Bg Shape">
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <a class="btn-default btn-large color-blacked" href="{{ route('pages.contact') }}">Try It Now <i
                                class="fa-sharp fa-light fa-arrow-right ml--5"></i></a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 mt--60">
                    <div class="collabration-image-section">
                        <img src="{{ asset('assets/images/split/split-2.png') }}" alt="collabration-image">
                        <div class="logo-section">
                            <div class="center-logo">
                                <img src="{{ asset('assets/images/split/split-2-logo.png') }}" alt="Small Logo">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="rainbow-rn-cta">
        <div class="container">
            <div class="row row--0 align-items-center content-wrapper">
                    ...
                    <div class="inner">
                        <div class="content text-left">
                            <h4 class="title sal-animate" data-sal="slide-up" data-sal-duration="400"
                                data-sal-delay="200">Join our aI Experts community</h4>
                    ...
                    <div class="right-content">
                        <div class="call-to-btn text-start text-lg-end sal-animate" data-sal="slide-up"
                            ...
                            <div class="team-image">
                                <img src="{{ asset('assets/images/cta-img/team-01.png') }}" alt="Group Image">
                            </div>
                ...
                <div class="bg-shape">
                    <img src="{{ asset('assets/images/cta-img/bg-shape-01.png') }}" alt="BG Shape">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <nav class="aiwave-tab">
                        <div class="tab-btn-grp nav nav-tabs text-center justify-content-center" id="nav-tab"
                            ...
                            <button class="nav-link with-badge active" id="nav-profile-tab" data-bs-toggle="tab"
            ...
            <div class="row row--15 service-wrapper">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-duration="700">
                    <div class="service service__style--1 aiwave-style text-center">
                        <div class="icon">
                            <img src="{{ asset('assets/images/service/service-icon-01.png') }}" alt="Servece Image">
                        </div>
                        <div class="content">
                            <h4 class="title w-600">100% No-Risk, Money Back Guarantee!</h4>
                            <p class="description b1 mb--0">Refunds will be issued within period of 14 days from the
                                purchase date</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 aiwave-style text-center">
                        <div class="icon">
                            <img src="{{ asset('assets/images/service/service-icon-02.png') }}" alt="Servece Image">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 aiwave-style text-center">
                        <div class="icon">
                            <img src="{{ asset('assets/images/service/service-icon-03.png') }}" alt="Servece Image">
                        </div>
                        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div
                        ...
                        <div class="slide-single-layout">
                            <div class="rainbow-box-card active card-style-default testimonial-style-defalt has-bg-shaped">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        <p class="description">Rainbow-Themes has become such an integral part of
                                        ...
                                        <div class="bottom-content">
                                            <div class="meta-info-section">
                                                ...
                                                <div class="desc-img">
                                                    <img src="{{ asset('assets/images/brand/brand-t.png') }}"
                                                        alt="Brand Image">
                                                </div>
                                            </div>
                                            <div class="meta-img-section">
                                                <a class="btn-default rounded-player style-two xs-size popup-video"
                                                    href="https://www.youtube.com/watch?v=ikEdN260zRg">
                                                    <span><i class="fa-duotone fa-play"></i></span>
                                                </a>
                                                <a class="image" href="#">
                                                    <img src="{{ asset('assets/images/team/team-02sm.jpg') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="bg-shape">
                                    <img src="{{ asset('assets/images/service/bg-testimonial.png') }}" alt=""
                                        class="bg">
                                    <img src="{{ asset('assets/images/service/bg-testimonial-hover.png') }}"
                                        alt="" class="bg-hover">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom-content">
                                            ...
                                            <div class="meta-img-section">
                                                <a class="btn-default rounded-player style-two xs-size small-size popup-video"
                                                    href="https://www.youtube.com/watch?v=ikEdN260zRg">
                                                    <span><i class="fa-duotone fa-play"></i></span>
                                                </a>
                                                <a class="image" href="#">
                        ...
                        <div class="slide-single-layout">
                            <div
                                class="rainbow-box-card active card-style-default testimonial-style-defalt has-bg-shaped">
                                <div class="inner">
                                    <div class="rating">
                                        <a href="#rating">
                                            <i class="fa-sharp fa-solid fa-star"></i>
                    ...
                    <div class="aiwave-cta">
                        <div class="inner">
                            <div class="content-left">
                                ...
                                <div class="app-store-btn">
                                    <a class="store-btn" href="#">
                                        <img src="{{ asset('assets/images/cta-img/play-app.png') }}"
                                            alt="Play Store Button">
                                    </a>
                                    <a class="store-btn" href="#">
                                        <img src="{{ asset('assets/images/cta-img/apple-app.png') }}"
                            ...
                            <div class="bg-shape-one">
                                <img src="{{ asset('assets/images/cta-img/bg-shape.png') }}" alt="Bg shape">
                            </div>
                        </div>
                    </div>
                </div>
